...
% Avoid fancyhdr warnings about \headheight being too small.
...
% Avoid duplicate PDF destination warnings while page numbers are suppressed.
...
\input{secciones/datos-y-covariables.tex}
\input{secciones/metodologia.tex}
\input{secciones/modelos.tex}
\input{secciones/resultados-y-discusion.tex}
\input{secciones/reproducibilidad.tex}
